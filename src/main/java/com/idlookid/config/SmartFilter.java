...
public class SmartFilter implements Filter {
	...
	public void doFilter(ServletRequest request, ServletResponse response,
		...
		HttpServletRequest syntheticRequest = new SyntheticRequest(
				(HttpServletRequest) request);
		HttpServletResponse syntheticResponse = new SyntheticResponse(
				(HttpServletResponse) response);
		HttpServletRequest syntheticRequest2 = new SyntheticRequest(
				(HttpServletRequest) request);
		HttpServletResponse syntheticResponse2 = new SyntheticResponse(
				(HttpServletResponse) response);
